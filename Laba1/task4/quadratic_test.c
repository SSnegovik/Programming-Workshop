...
bool is_values_equal(long double a, long double b, long double epsilon) {
  return fabs(a - b) < epsilon;
}

void test_zero_coefficient_a() {
  long double *result = find_roots(0, 1, 1);
  assert(result == NULL);
}

void test_coefficient_1_0_m1() {
  long double *result = find_roots(1, 0, -1);
...
void test_coefficient_1_0_0() {
  long double *result = find_roots(1, 0, 0);
...
void test_coefficient_1_0_m1em7() {
  ...
  long double *result = find_roots(1, 0, -1e-7);
...
void test_coefficient_1_m1e10_m1() {
  ...
  long double *result = find_roots(1, -1E+10, -1);
...
void test_coefficient_1_0_m1em8() {
  ...
  long double *result = find_roots(1, 0, -1E-8);
